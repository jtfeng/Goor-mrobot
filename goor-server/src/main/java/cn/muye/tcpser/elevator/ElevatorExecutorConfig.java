...
@Configuration
@EnableAsync
public class ElevatorExecutorConfig {
    ...
    @Bean
    public Executor elevatorTcpSerAsync() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(corePoolSize);
        executor.setMaxPoolSize(maxPoolSize);
        executor.setQueueCapacity(queueCapacity);
        executor.setThreadNamePrefix("ElevatorTcpSerExecutor-");
    ...
    @Bean
    public Executor elevatorTcpSerClientAsync() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(corePoolSize);
        executor.setMaxPoolSize(maxPoolSize);
        executor.setQueueCapacity(queueCapacity);
        executor.setThreadNamePrefix("ElevatorTcpSerClientExecutor-");
    ...
    @Bean
    public ElevatorAsyncTask elevatorAsyncTask(
            ElevatorClientAsyncTask elevatorClientAsyncTask
    ){
        return new ElevatorAsyncTask(elevatorClientAsyncTask);
    }
}
