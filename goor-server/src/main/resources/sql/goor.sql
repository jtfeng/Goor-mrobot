...
CREATE TABLE `A_MAP_INFO` (
  ...
  `FLOOR` INT DEFAULT NULL COMMENT '相对楼层',
...
CREATE TABLE `A_MAP_POINT` (
  ...
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `POINT_NAME` varchar(256) DEFAULT NULL COMMENT '唯一标识符',
  `POINT_ALIAS` varchar(256) DEFAULT NULL COMMENT '显示名称',
...
CREATE TABLE `A_STATION` (
  ...
  `RESSCENE` varchar(64) DEFAULT NULL COMMENT '资源场景',
...
ALTER TABLE A_STATION ADD ROBOT_ACCESS int(1) DEFAULT 0 COMMENT '机器人是否可达 0：机器人可达，1 ：机器人不可达';
-- ----------------------------
...
ALTER TABLE A_STATION_STATION_XREF ADD ORDER_INDEX INT(11) NULL DEFAULT 0 COMMENT '可到达站排序索引';
...
CREATE TABLE `as_goods_type` (
  ...
  `ROBOT_TYPE_ID` int(20) DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
INSERT INTO `AS_GOODS_TYPE` VALUES ('1', '药物','1', '2017-07-07 11:47:02', null, 0 ,'1', '100');
INSERT INTO `AS_GOODS_TYPE` VALUES ('2', '垃圾','1', '2017-07-07 11:47:05', null, 0 ,'1', '100');
...
CREATE TABLE `AS_ROBOT_CONFIG` (
  ...
  `LOW_BATTERY_THRESHOLD` int(3) DEFAULT NULL COMMENT '低电量阈值',
  `SUFFICIENT_BATTERY_THRESHOLD` int(3) DEFAULT NULL COMMENT '足电量阈值',
  `CREATE_TIME` datetime DEFAULT NULL,
  `CREATED_BY` bigint(20) DEFAULT NULL,
  `STORE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
ALTER TABLE `OR_ORDER_SETTING` ADD COLUMN `NEED_AUTO_CHARGE`  tinyint(1) NULL DEFAULT NULL COMMENT '需要自动回充' AFTER `NEED_SHELF`;
-- ----------------------------
...
CREATE TABLE `VOICE_FILE` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `VOICE_KEY` varchar(255) DEFAULT NULL COMMENT '文件名KEY',
...
DROP TABLE IF EXISTS `AS_ELEVATOR_NOTICE`;
create table AS_ELEVATOR_NOTICE(
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `CALL_FLOOR` int  comment '当前呼叫楼层',
  `TARGET_FLOOR`  int  comment '到达目标楼层',
  `ELEVATOR_ID` bigint  comment '对应的电梯 ID 信息',
  `TO_STATION_ID` bigint  comment '发送对象站ID',
  `UUID` VARCHAR(50)  comment 'UUID',
  `ROBOT_CODE` VARCHAR(50)  comment '机器人code',
  `STATE` int  comment '状态:0 :初始状态，1：pad接收到消息并反馈',
   PRIMARY KEY (`ID`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `MESSAGE_BELL` (
  ...
  `MISSION_ITEM_ID` bigint(12) DEFAULT NULL,
  `STATUS` int(12) DEFAULT NULL COMMENT '状态',
  `STORE_ID` bigint(12) DEFAULT NULL,
  `CREATED_BY` bigint(12) DEFAULT NULL,
  `CREATE_TIME` datetime DEFAULT NULL,
...
ALTER TABLE A_MAP_INFO ADD `LOGIC_FLOOR` INT DEFAULT 0 COMMENT '逻辑楼层，可以为负';

DROP TABLE IF EXISTS `MISSION_WARNING`;
CREATE TABLE `MISSION_WARNING` (
  `ID` bigint(12) NOT NULL AUTO_INCREMENT,
  `START_STATION_ID` bigint(12) DEFAULT NULL COMMENT '起始点id',
  `END_STATION_ID` bigint(12) DEFAULT NULL COMMENT '结束点id',
  `ARTIFICAL_TIME` bigint(20) DEFAULT NULL COMMENT '人为定义 时间，单位秒',
  `CALCULATE_TIME` bigint(20) DEFAULT NULL COMMENT '计算时间 单位秒',
  `USE_ARTIFICAL_TIME` tinyint(1) DEFAULT NULL,
  `ACTION_TIME` int(12) DEFAULT NULL COMMENT '执行次数',
  `CREATED_TIME` datetime DEFAULT NULL,
  `UPDATED_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `OR_APPLY_ORDER`;
CREATE TABLE `OR_APPLY_ORDER` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `APPLY_STATION_ID` bigint(20) DEFAULT NULL COMMENT '发起申请站id',
  `SEND_STATION_ID` bigint(20) DEFAULT NULL COMMENT '请求发送站id',
  `ORDER_ID` bigint(20) DEFAULT NULL COMMENT '关联订单id',
  `APPLY_NUM` varchar(64) DEFAULT NULL COMMENT '申请货物手动输入编号',
...
-- ----------------------------
-- ----------------------------
-- 插入手术室用户，用户ID，roleId,用户密码需要按情况修改
-- ----------------------------
INSERT INTO `AC_ROLE` VALUES ('100', '无菌器械室管理员', '100', '1', '2017-06-29 14:39:19');
INSERT INTO `AC_USER` VALUES ('1000', 'operation', '123456', '', '9999', '100', '1', '2017-06-27 10:59:28');
INSERT INTO `AC_USER_ROLE_XREF` VALUES ('199', '1000', '100');
...
DROP TABLE IF EXISTS `ERP_APPLIANCE_DEPARTMENT_TYPE`;
CREATE TABLE `ERP_APPLIANCE_DEPARTMENT_TYPE` (
  `CODE` INT DEFAULT 0,
  `NAME` varchar(50) DEFAULT NULL COMMENT '器械名称'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ERP_APPLIANCE_DEPARTMENT_TYPE
-- ----------------------------
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('1', '4F_CICU');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('2', '4F手术室-心脏');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('3', '2F人流室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('4', '外来器械');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('5', '3F盆底康复科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('6', '4F手术室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('7', '8F西心血管');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('8', '日间手术室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('9', '5F_NICU');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('10', '4F胃镜');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('11', '5F_PICU');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('12', '低温腔镜（妇科手术室）');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('13', '4F手术室-儿科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('14', '5F新生儿');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('15', '6F西产前');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('16', '5F西-外科NICU');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('17', '低温腔镜（儿科手术室）');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('18', '4F口腔科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('19', '2F眼科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('20', '11F东产八');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('21', '4F产前诊断中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('22', '10F东神经内科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('23', '10F东内分泌');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('24', '14F层流病房东区');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('25', '14F血液科西区');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('26', '4F耳鼻喉');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('27', '8F东五官科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('28', '3F妇科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('29', '通用包');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('30', '母乳库');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('31', '1F儿科观察室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('32', '6F东产房');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('33', '营养室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('34', '4F生殖中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('35', '13F脐血库');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('36', '12东产后六组');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('37', '3F检验科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('38', '7F东产后3组');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('39', '4F手术室-妇科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('40', '5F血液日间病房');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('41', '1F介入治疗室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('42', '低温器械（心脏手术室）');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('43', '骨科专科（珠）');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('44', '13F冻存室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('45', '1F妇产科急诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('46', '3F成人综合门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('47', '9F西普外科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('48', '11F西生殖妇科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('49', '1F配置中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('50', '12F西妇科肿瘤');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('51', '7F西产后2组');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('53', '3F儿外科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('54', '3F东出生队列研究所');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('55', '9F东骨泌尿外科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('56', '1F放射科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('57', '早产防治实验室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('58', '13F精密仪器');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('59', '10F呼吸消化');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('60', '儿内科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('61', '2F呼吸门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('62', '整形美容外科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('63', '3F儿内(B超室)');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('64', '2F消化科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('65', '3F成人内科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('66', '1F儿童补液室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('67', '隔离门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('68', '2F特诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('69', '1F影像中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('70', '儿科B超室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('71', '小儿复苏室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('72', '2F儿科特诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('73', '3F儿内');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('74', '2F皮肤科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('75', '3F产科门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('76', '3F乳腺外科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('77', '3F成人中医');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('78', '3F产科抽血室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('79', '13F细胞遗传');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('80', '1F体检中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('81', '2F妇科抽血室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('82', '3F中医妇科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('83', '5F免疫日间病区');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('84', '日间手术病房');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('85', '13F内分泌实验室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('86', '13F外科实验室(1308室)');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('87', '13F血液实验中心');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('88', '13F免疫学实验室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('89', '3F微创消化功能室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('90', '低温器械（人流室)');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('91', '3F儿童早期综合发展');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('92', '中医儿科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('93', '3F内分泌门诊');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('94', '妇科日间手术病区（珠）');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('95', '4F产前诊断中心实验室');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('96', '低温－骨科专用');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('97', '低温灭菌包');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('98', '教育管理科');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('99', '科教科(保利509)');
INSERT INTO `ERP_APPLIANCE_DEPARTMENT_TYPE` VALUES ('100', '儿保科');

-- ----------------------------
-- Table structure for ERP_APPLIANCE_PACKAGE_TYPE
-- ----------------------------
DROP TABLE IF EXISTS `ERP_PACKAGE_TYPE`;
DROP TABLE IF EXISTS `ERP_APPLIANCE_PACKAGE_TYPE`;
CREATE TABLE `ERP_APPLIANCE_PACKAGE_TYPE` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `NAME` varchar(50) DEFAULT NULL COMMENT '器械名称',
  `DELETE_FLAG` int DEFAULT 1 COMMENT '数据库删除状态 0 :正常 1：删除',
  `DELETE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '删除时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ERP_APPLIANCE_PACKAGE_TYPE
-- ----------------------------
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('1', '100', '100', '2017-12-18 13:54:12','纸塑包','0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('2', '100', '100', '2017-12-18 13:54:12','无纺布(单层)','0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('3', '100', '100', '2017-12-18 13:54:12','无纺布(双层)','0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('4', '100', '100', '2017-12-18 13:54:12','无纺布(三层)', '0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('5', '100', '100', '2017-12-18 13:54:12','清洗消毒包装', '0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('6', '100', '100', '2017-12-18 13:54:12','铁质容器', '0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('7', '100', '100', '2017-12-18 13:54:12','棉布包', '0', null);
INSERT INTO `ERP_APPLIANCE_PACKAGE_TYPE` VALUES ('8', '100', '100', '2017-12-18 13:54:12','硬式灭菌专用器', '0', null);


-- ----------------------------
-- Table structure for ERP_OPERATION_DEPARTMENT_TYPE
-- ----------------------------
DROP TABLE IF EXISTS `ERP_OPERATION_DEPARTMENT_TYPE`;
CREATE TABLE `ERP_OPERATION_DEPARTMENT_TYPE` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `NAME` varchar(50) DEFAULT NULL COMMENT '手术科室类别名称',
  `DELETE_FLAG` int DEFAULT 1 COMMENT '数据库删除状态 0 :正常 1：删除',
  `DELETE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '删除时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Records of ERP_OPERATION_DEPARTMENT_TYPE
-- ----------------------------
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('1', '100', '100', '2017-12-19 13:54:12','NICU(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('2', '100', '100', '2017-12-19 13:54:12','PICU(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('3', '100', '100', '2017-12-19 13:54:12','儿童骨科(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('4', '100', '100', '2017-12-19 13:54:12','耳鼻喉二组(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('5', '100', '100', '2017-12-19 13:54:12','口腔二组(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('6', '100', '100', '2017-12-19 13:54:12','泌尿一组', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('7', '100', '100', '2017-12-19 13:54:12','普通与泌尿妇科(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('8', '100', '100', '2017-12-19 13:54:12','日间病房手术', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('9', '100', '100', '2017-12-19 13:54:12','日间手术病房', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('10', '100', '100', '2017-12-19 13:54:12','生殖免疫妇科(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('11', '100', '100', '2017-12-19 13:54:12','小儿泌尿外科(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('12', '100', '100', '2017-12-19 13:54:12','新生儿(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('13', '100', '100', '2017-12-19 13:54:12','新生儿外科监护室', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('14', '100', '100', '2017-12-19 13:54:12','新生儿外科三组', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('15', '100', '100', '2017-12-19 13:54:12','眼科二组(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('16', '100', '100', '2017-12-19 13:54:12','肿瘤妇科乳腺外科(珠)', '0', null);
INSERT INTO `ERP_OPERATION_DEPARTMENT_TYPE` VALUES ('17', '100', '100', '2017-12-19 13:54:12','肿瘤外科二组', '0', null);


-- ----------------------------
-- Table structure for ERP_OPERATION_DEFAULT_APPLIANCE_XREF
-- ----------------------------
DROP TABLE IF EXISTS `ERP_OPERATION_DEFAULT_APPLIANCE_XREF`;
CREATE TABLE `ERP_OPERATION_DEFAULT_APPLIANCE_XREF` (
  `NUMBER` int DEFAULT 0 COMMENT '额外器械数量',
  `APPLIANCE_ID` bigint DEFAULT 0 COMMENT '额外器械ID',
  `OPERATION_TYPE_ID` bigint DEFAULT 0 COMMENT '手术类型ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for ERP_OPERATION_TYPE
-- ----------------------------
DROP TABLE IF EXISTS `ERP_OPERATION_TYPE`;
CREATE TABLE `ERP_OPERATION_TYPE` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `NAME` varchar(100) DEFAULT NULL COMMENT '手术类型名称',
  `OPERATION_DEPARTMENT_TYPE_ID` bigint DEFAULT 0 COMMENT '手术科室类别ID',
  `SEARCH_NAME` varchar(100) DEFAULT NULL COMMENT '器械名称拼音首字母字符串',
  `DELETE_FLAG` int DEFAULT 1 COMMENT '数据库删除状态 0 :正常 1：删除',
  `DELETE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '删除时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
DROP TABLE IF EXISTS `ERP_STATION_PAD_PASSWORD_XREF`;
DROP TABLE IF EXISTS `ERP_STATION_MAC_PASSWORD_XREF`;
CREATE TABLE `ERP_STATION_MAC_PASSWORD_XREF` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `PASSWORD` varchar(50) DEFAULT NULL COMMENT '预置密码',
  `MAC` varchar(50) DEFAULT NULL COMMENT 'pad MAC地址',
  `STATION_ID` bigint DEFAULT 0 COMMENT '站编号',
  `TYPE` int DEFAULT NULL COMMENT '1:无菌器械室  2：手术室',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


-- ----------------------------
-- Table structure for ERP_OPERATION_ORDER_APPLIANCE_XREF
-- ----------------------------
DROP TABLE IF EXISTS `ERP_OPERATION_ORDER_APPLIANCE_XREF`;
CREATE TABLE `ERP_OPERATION_ORDER_APPLIANCE_XREF` (
  `NUMBER` int DEFAULT 0 COMMENT '额外器械数量',
  `APPLIANCE_ID` bigint DEFAULT 0 COMMENT '额外器械ID',
  `OPERATION_ORDER_ID` bigint DEFAULT 0 COMMENT '手术室订单ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


-- ----------------------------
-- Table structure for ERP_OPERATION_ORDER
-- ----------------------------
DROP TABLE IF EXISTS `ERP_OPERATION_ORDER`;
CREATE TABLE `ERP_OPERATION_ORDER` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `STORE_ID` bigint(20) DEFAULT NULL COMMENT '店铺ID',
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `STATION_ID` bigint DEFAULT 0 COMMENT '手术室站ID',
  `HANDLE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '立即处理时间',
  `STATE` int(1) COMMENT '订单状态',
  `TYPE` int(1) COMMENT '订单类型',
    PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

ALTER TABLE `ERP_OPERATION_ORDER` ADD COLUMN OPERATION_TYPE_ID bigint(20) DEFAULT NULL COMMENT '手术类型ID' ;
ALTER TABLE `ERP_OPERATION_ORDER` ADD COLUMN RECEIVE_TIME datetime DEFAULT CURRENT_TIMESTAMP COMMENT '无菌器械室订单接收时间';

DROP TABLE IF EXISTS `A_ELEVATORSTATION_ELEVATOR_XREF`;
create table A_ELEVATORSTATION_ELEVATOR_XREF
(
  ID bigint auto_increment comment '主键 ID 编号'
    primary key,
  ELEVATORSTATION_ID bigint null comment '电梯站点 ID',
  ELEVATOR_ID bigint null comment '电梯 ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
