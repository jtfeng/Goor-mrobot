...
ALTER TABLE `AS_ROADPATH`
MODIFY COLUMN `DATA`  varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `PATTERN`,
...
ALTER TABLE AS_ELEVATOR_NOTICE ADD COLUMN `FROM_STATION_NAME` VARCHAR(100) DEFAULT NULL COMMENT '发货站名称';
ALTER TABLE AS_ELEVATOR_NOTICE ADD COLUMN `GOODS_TYPE_NAME` VARCHAR(100) DEFAULT NULL COMMENT '物品类型名称';
...
ALTER TABLE `ERP_OPERATION_ORDER` ADD COLUMN COMMENT VARCHAR(500) DEFAULT null COMMENT '备注';
