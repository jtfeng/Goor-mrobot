...
(
  ...
  X DOUBLE(10,3) COMMENT '坐标X',
  Y DOUBLE(10,3) COMMENT '坐标Y',
  TH DOUBLE(10,3) COMMENT '坐标旋转角度',
...
(
  ...
  SCENE_NAME VARCHAR(256) NOT NULL COMMENT '场景名称',
  FILE_PATH VARCHAR(256) COMMENT '文件路径',
  VERSION VARCHAR(256) COMMENT '版本号',
  FILE_NAME DOUBLE(10,3) COMMENT '文件名',
  CREATE_DATE DOUBLE(10,3) COMMENT '创建时间'
);