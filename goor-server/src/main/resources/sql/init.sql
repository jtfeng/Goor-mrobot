...
CREATE TABLE `A_MAP_INFO` (
  ...
  `LOGIC_FLOOR` int DEFAULT 0 COMMENT '逻辑楼层，可以为负',
  PRIMARY KEY (`ID`)
...
CREATE TABLE `A_STATION` (
  ...
  `ROBOT_ACCESS` int(1) DEFAULT 0 COMMENT '机器人是否可达 0：机器人可达，1 ：机器人不可达',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `A_STATION_STATION_XREF` (
  ...
  `ORDER_INDEX` int(11) DEFAULT 0 COMMENT '可到达站排序索引'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of a_station_station_xref
-- ----------------------------
INSERT INTO `A_STATION_STATION_XREF` VALUES ('2', '4',0);
INSERT INTO `A_STATION_STATION_XREF` VALUES ('2', '5',0);
INSERT INTO `A_STATION_STATION_XREF` VALUES ('2', '7',0);
...
-- ----------------------------
INSERT INTO `AC_USER_ROLE_XREF` VALUES ('1', '1', '1', '100', '1', '2017-11-09 00:00:00');
INSERT INTO `AC_USER_ROLE_XREF` VALUES ('2', '2', '2', '100', '1', '2017-11-09 00:00:00');
...
-- Records of AS_SCENE
-- ----------------------------
INSERT INTO `AS_SCENE` VALUES (1, '默认场景', null, '0', 100, 1, now(), 1,1);
...
-- Records of AS_SHELF
-- ----------------------------
INSERT INTO `AS_SHELF` VALUES ('1', 'test0', 'test0', 'tes0', 'test0', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('2', 'test1', 'test1', 'test1', 'test1', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('3', 'test2', 'test2', 'tes2', 'test2', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('4', 'test3', 'test3', 'tes3', 'test3', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('5', 'test4', 'test4', 'test4', 'test4', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('9', 'test8', 'test8', 'test8', 'test8', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('10', 'test9', 'test9', 'tes9', 'test9', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('11', 'test10', 'test10', 'tes10', 'test10', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('12', 'test11', 'test11', 'test11', 'test11', null, '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('13', 'test12', 'test12', 'test12', 'test12', 'c', '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('14', 'huojia007', 'afadsf', '1234', '88888', '99999', '100', '1', '2017-07-03 20:30:31',1);
INSERT INTO `AS_SHELF` VALUES ('16', 'huojia360', '货架360', '1234', '185485', 'huojia360', '100', '1', '2017-07-10 09:30:39',1);
INSERT INTO `AS_SHELF` VALUES ('17', '55', '55', '55', '55', '55', '100', '1', '2017-07-10 14:03:47',1);
INSERT INTO `AS_SHELF` VALUES ('18', '345', '345', '345', '345', '345', '100', '1', '2017-07-10 14:22:49',1);
INSERT INTO `AS_SHELF` VALUES ('19', '567', '567', '567', '456', '456', '100', '1', '2017-07-10 14:27:03',1);
INSERT INTO `AS_SHELF` VALUES ('20', '456456', '456456', '345345345', '345345', '345345', '100', '1', '2017-07-10 14:29:24',1);
INSERT INTO `AS_SHELF` VALUES ('21', '987', '987', '987', '987', '987', '100', '1', '2017-07-10 15:04:51',1);
INSERT INTO `AS_SHELF` VALUES ('22', '1111', '1111', '1111', '1111', '1111', '100', '1', '2017-07-10 15:58:32',1);
INSERT INTO `AS_SHELF` VALUES ('23', '34676757', '4356456', '345345', '34545', '5555', '100', '1', '2017-07-10 16:33:23',1);
INSERT INTO `AS_SHELF` VALUES ('25', '测试货架1_detail', '测试货架1_detail', '测试货架1_detail', '测试货架1_detail', '测试货架1_detail', '100', '1', '2017-07-10 18:03:50',1);
INSERT INTO `AS_SHELF` VALUES ('27', '测试货架3_detail', '测试货架3_detail', '测试货架3_detail', 'XXXXXXXX', '测试货架3_detail', '100', '1', '2017-07-10 20:39:03',1);
INSERT INTO `AS_SHELF` VALUES ('28', 'uuuu', 'uuuu', 'uuuu', 'uuuu', 'uuuu', '100', '1', '2017-07-11 11:06:42',1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='货架与可装配货物类型关系表';
...
CREATE TABLE `LOG_CHARGE_INFO` (
  ...
  `CHARGING_STATUS` int(1) DEFAULT NULL,
  `PLUGIN_STATUS` int(1) DEFAULT NULL,
  `POWER_PERCENT` int(11) DEFAULT NULL,
  `AUTO_CHARGING` int(1) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ROBOT_MAPZIP_XREF` (
  ...
  `MAP_ZIP_ID` bigint(20) DEFAULT NULL COMMENT '地图压缩包ID',
  `SCENE_ID` bigint(20) DEFAULT NULL COMMENT '场景ID',
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '更新时间',
  `DELETE_FLAG` INT DEFAULT NULL COMMENT '删除标志位 0 :正常 1：删除',
...
CREATE TABLE `OR_ORDER_SETTING` (
  ...
  `NEED_AUTO_CHARGE` tinyint(1) DEFAULT NULL COMMENT '需要自动回充',
...
(
  `ID` bigint auto_increment primary key comment 'ID 序号列表',
...
INSERT INTO AS_ELEVATORMODE (START, END, STATE, ELEVATOR_ID, CREATED_BY, CREATE_TIME, STORE_ID) VALUES ('10:10:10', '13:13:13', 1, 1, null, null, null);
INSERT INTO AS_ELEVATORMODE (START, END, STATE, ELEVATOR_ID, CREATED_BY, CREATE_TIME, STORE_ID) VALUES ('20:10:10', '23:13:13', 1, 1, null, null, null);
INSERT INTO AS_ELEVATORMODE (START, END, STATE, ELEVATOR_ID, CREATED_BY, CREATE_TIME, STORE_ID) VALUES ('02:10:10', '03:13:13', 1, 1, null, null, null);
...
create table AS_ELEVATOR_NOTICE(
  ...
  `FROM_STATION_NAME` VARCHAR(100) DEFAULT NULL COMMENT '发货站名称',
  `GOODS_TYPE_NAME` VARCHAR(100) DEFAULT NULL COMMENT '物品类型名称',
  `TYPE`  int DEFAULT 0 COMMENT '消息类型 1:电梯pad消息  2:多站融合消息',
  `ORDER_DETAIL_ID`  bigint(20) DEFAULT NULL COMMENT '订单细节id',
  `DATA`  VARCHAR(400) DEFAULT NULL COMMENT '详细数据',
   PRIMARY KEY (`ID`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
--  Table structure for `SCENES_ROBOTS_RELATIONS`
-- ----------------------------
DROP TABLE IF EXISTS `SCENES_ROBOTS_RELATIONS`;
CREATE TABLE `SCENES_ROBOTS_RELATIONS` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID 编号',
  `SCENE_ID` bigint(20) DEFAULT NULL COMMENT '场景 ID',
  `ROBOT_ID` bigint(20) DEFAULT NULL COMMENT '机器人信息 ID',
  PRIMARY KEY (`ID`),
  KEY `SCENES_ROBOTS_RELATIONS_AS_SCENE_ID_fk` (`SCENE_ID`),
  KEY `SCENES_ROBOTS_RELATIONS_AS_ROBOT_ID_fk` (`ROBOT_ID`),
  CONSTRAINT `SCENES_ROBOTS_RELATIONS_AS_ROBOT_ID_fk` FOREIGN KEY (`ROBOT_ID`) REFERENCES `AS_ROBOT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `SCENES_ROBOTS_RELATIONS_AS_SCENE_ID_fk` FOREIGN KEY (`SCENE_ID`) REFERENCES `AS_SCENE` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='场景信息与机器人信息多对多关系映射表';

--

-- ----------------------------
--  Table structure for `SCENES_MAPS_RELATIONS`
-- ----------------------------
DROP TABLE IF EXISTS `SCENES_MAPS_RELATIONS`;
CREATE TABLE `SCENES_MAPS_RELATIONS` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `SCENE_ID` bigint(20) DEFAULT NULL COMMENT '场景 ID',
  `MAP_SCENENAME` varchar(50) DEFAULT NULL COMMENT '地图场景名称',
  PRIMARY KEY (`ID`),
  KEY `SCENES_MAPS_RELATIONS_AS_SCENE_ID_fk` (`SCENE_ID`),
  KEY `SCENES_MAPS_RELATIONS_A_MAP_INFO_ID_fk` (`MAP_SCENENAME`),
  CONSTRAINT `SCENES_MAPS_RELATIONS_AS_SCENE_ID_fk` FOREIGN KEY (`SCENE_ID`) REFERENCES `AS_SCENE` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='场景与地图的多对多关系映射表';
...
INSERT INTO `AC_USER_ROLE_XREF` VALUES ('199', '1000', '100', '100', '1', '2017-11-09 00:00:00');
...
CREATE TABLE `ERP_APPLIANCE` (
  ...
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `NAME` varchar(200) DEFAULT NULL COMMENT '器械名称',
...
CREATE TABLE `ERP_OPERATION_DEPARTMENT_TYPE` (
  ...
  `CREATED_BY` bigint(20) DEFAULT NULL COMMENT '创建人',
  `CREATE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `NAME` varchar(200) DEFAULT NULL COMMENT '手术科室类别名称',
  `DELETE_FLAG` int DEFAULT 1 COMMENT '数据库删除状态 0 :正常 1：删除',
  `DELETE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '删除时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ERP_OPERATION_ORDER` (
  ...
  `OPERATION_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '手术类型ID',
  `RECEIVE_TIME` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '无菌器械室订单接收时间',
...
(
  `ID` bigint auto_increment primary key comment '主键 ID 编号',
