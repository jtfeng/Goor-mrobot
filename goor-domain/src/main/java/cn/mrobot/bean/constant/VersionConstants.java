...
public class VersionConstants {
    ...
    public final static String VERSION_NOAH_GOOR_SERVER = "NOAH_GoorServer_Ver0.0.0.1032_test";//服务端：NOAH_GoorServer_Ver0.0.0.1012_test
    public final static String VERSION_NOAH_GOOR_KEY = "goor_version";//agent端键名
    public final static String VERSION_NOAH_GOOR = "NOAH_Goor_Ver0.0.0.1009_test";//agent端：NOAH_Goor_Ver0.0.0.1007_test
