...
public class Constant {
    ...
    */
    ...
    public static final Integer IS_ORDER_STATION = 0;
    public static final Integer IS_ELEVATOR_STATION = 1;
    public static final Integer IS_MULTI_RECEIVING_STATION = 2;
