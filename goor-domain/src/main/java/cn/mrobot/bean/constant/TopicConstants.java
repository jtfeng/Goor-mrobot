...
public class TopicConstants {
	...
	public static final String PUB_NAME_MISSION_LIST_TASK = "mission_list_task"; //场景任务终止的pubName
	public static final String SUB_NAME_ROBOT_INFO_REPLY = "robot_info_reply"; //应用那边同步机器人信息(电量阈值)结果的回执subName
	public static final String SUB_NAME_MISSION_LIST_TASK_REPLY = "mission_list_task_reply";
