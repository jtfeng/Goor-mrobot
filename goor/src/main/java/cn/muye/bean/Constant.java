...
//
//	public static final String DATA = "data"; //管理后台标识
//
//	public static final String ATHENA = "athena"; //管理后台标识
//
...
//
//	public static final String CHARGING_STATUS_INQUIRY = "charging_status_inquiry"; //充电状态
//	public static final String MOTION_PLANNER_MOTION_STATUS = "motion_planner_motion_status"; //反馈运动状态
//
//	public static final String GOOR_SERVER = "goor-server";
//	public static final String GOOR_SERVER_CHAY = "goor-server-chay";
//
//
//}
